...
EPOCH_METRIC_FIELDS = (
    ...
    "case_peak_temperature_pred",
    "case_peak_temperature_fem",
    "case_peak_temperature_error",
    "case_peak_temperature_abs_error",
    "case_peak_temperature_rmse",
    "case_peak_temperature_rise_pred",
    "case_peak_temperature_rise_fem",
    "case_peak_temperature_rise_error",
    "case_peak_temperature_rise_abs_error",
    "case_peak_temperature_rise_rmse",
    ...
    "case_peak_topk_temperature_rise_rmse",
    "loss_temperature",
    "loss_teacher_forcing_temperature",
    "loss_rollout_temperature",
    "loss_pde",
    "loss_outflow",
    "loss_beta",
    "loss_smooth",
    ...
    "rollout_fem_temperature_rmse",
    "rollout_fem_temperature_mae",
    "rollout_fem_temperature_max_error",
    "temperature_mean",
    "temperature_max",
    "temperature_min",
    "temperature_var",
